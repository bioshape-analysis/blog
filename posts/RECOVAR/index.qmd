...
Recent developed software RECOVAR [@Gilles2023], using a linear mapping like 3DVA, was shown to achieve comparable or even better performance with deep learning methods, and meanwhile has high interpretability and allows easy recovery of motions/trajectories from latent space. In this blog, I will review the pipeline of RECOVAR, present heterogeneity analysis results from the original paper and our SARS-CoV2 spike protein dataset, and discuss some possible improvements we can make to this pipeline.
