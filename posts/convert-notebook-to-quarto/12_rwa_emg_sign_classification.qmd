...
Geomstats is a Python package for computations, statistics, machine learning, and deep learning on manifolds [@Geomstats].
...
This notebook is adapted from [here](https://github.com/geomstats/geomstats/blob/main/notebooks/12_real_world_applications__emg_sign_classification_in_spd_manifold.ipynb) 
...
![](paper_rock_scissors.png){ width=65% style="display: block; margin-left: auto; margin-right: auto;" }
