...
R-loops are three-stranded nucleic acid structures containing a DNA:RNA hybrid and an associated single DNA strand. They are normally created when DNA and RNA interac throughout the lifespan of a cell. Although their existence can be beneficial to a cell, an excessive formation of these objects is commonly associated with instability phenotypes.
...
<div style="text-align: center;">
![Fig.6 White pixels projected onto the preshape space](data/kendall_projected.png)
</div>

Taking a close look at it will reveal more details about where the points lie in the space.

<div style="text-align: center;">
![Fig.7 White pixels projected onto the preshape space](data/kendall_projected_2.png)
</div>
